...
mvn install:install-file   -Dfile=./apiproxy/resources/java/ubiqsecurity-2.2.3.jar   -DgroupId=com.ubiqsecurity   -DartifactId=ubiqsecurity   -Dversion=2.2.3   -Dpackaging=jar   -DgeneratePom=true
